...
//import com.coursera.spark.wk2.StackOverflow.sc
...
object StackOverflow {
  ...
  def apply(fileLocation: String, sc:SparkContext) = new StackOverflow(fileLocation, sc)
...
class StackOverflow(fileLocation: String, sc:SparkContext) extends Serializable {

  def readLines = sc.textFile(fileLocation, 8)
